...
const RecommendFood = ({foodName ="Test", gram=100, kcal=200}) => {
  return (
    <div className="w-44 flex flex-col items-center bg-blue-800/20 rounded-[10px] border border-blue-800 p-5">
      <img src={imgFood} className="w-12 h-12"/>
      <p className="text-black text-xl font-bold mt-2">{foodName}</p>
      <p className="text-black text-l font-normal ">{gram}g</p>
